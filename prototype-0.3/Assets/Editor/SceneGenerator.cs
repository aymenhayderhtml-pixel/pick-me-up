...
public static class SceneGenerator
{
    ...
    private static void CreateRosterScene(string path)
    {
        ...
        // Filter Buttons
        GameObject filters = CreateUIElement("Filters", canvas, new Vector2(900, 80), new Vector2(-450, 390));
        ...
        Image detailPortrait = CreateUIElement("img_Portrait", detail, new Vector2(220, 280), new Vector2(-180, 220)).AddComponent<Image>();
        ...
        rosterSo.FindProperty("detail_Portrait").objectReferenceValue = detailPortrait;
        rosterSo.FindProperty("detail_Name").objectReferenceValue = detailName;
        rosterSo.FindProperty("detail_Stars").objectReferenceValue = detailStars;
        rosterSo.FindProperty("detail_Class").objectReferenceValue = detailClass;
        rosterSo.FindProperty("detail_Level").objectReferenceValue = detailLevel;
        rosterSo.FindProperty("detail_HP").objectReferenceValue = detailHP;
        rosterSo.FindProperty("detail_ATK").objectReferenceValue = detailATK;
        rosterSo.FindProperty("detail_DEF").objectReferenceValue = detailDEF;
        rosterSo.FindProperty("detail_SPD").objectReferenceValue = detailSPD;
        rosterSo.FindProperty("detail_Morale").objectReferenceValue = detailMorale;
        rosterSo.FindProperty("detail_Trait").objectReferenceValue = detailTrait;
        rosterSo.FindProperty("detail_Status").objectReferenceValue = detailStatus;
        rosterSo.FindProperty("detail_History").objectReferenceValue = detailHistory;
        ...
        rosterSo.FindProperty("btn_FilterDead").objectReferenceValue = filterDead;
